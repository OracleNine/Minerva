            ...
            if (category == "q_propose") {
                ...
                if (result.length === 0) {
                    ...
                    const proposal_select = new discord_js_1.StringSelectMenuBuilder()
                        ...
                        .setValue("amd_admin"), new discord_js_1.StringSelectMenuOptionBuilder()
                        .setLabel("Amendent of Roleplay Charter")
                        .setDescription("THRESHOLD: 2/3")
                        .setValue("amd_rp"), new discord_js_1.StringSelectMenuOptionBuilder()
                        .setLabel("Amendent of Formatting Guidelines")
                        .setDescription("THRESHOLD: 2/3")
                        .setValue("amd_format"), new discord_js_1.StringSelectMenuOptionBuilder()
                        .setLabel("Amendent of Community Guidelines")
                        .setDescription("THRESHOLD: 2/3")
                        .setValue("amd_community"), new discord_js_1.StringSelectMenuOptionBuilder()
